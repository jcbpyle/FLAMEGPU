...
def initial_state_creation(file_name,agent_information):
	SAVE_DIRECTORY = BASE_DIRECTORY+"/testing_model/examples/PreyPredator/iterations."+"/"
...
base_agent_information = [["grass",["initial_population",0,5000],["x",-1.0,1.0],["y",-1.0,1.0],["type",2,2],["dead_cycles",0,0],["available",1,1],],["prey",["initial_population",0,5000],["x",-1.0,1.0],["y",-1.0,1.0],["type",1,1],["fx",-1.0,1.0],["fy",-1.0,1.0],["steer_x",0,0],["steer_y",0,0],["life",5,50],],["predator",["initial_population",0,5000],["x",-1.0,1.0],["y",-1.0,1.0],["type",1,1],["fx",-1.0,1.0],["fy",-1.0,1.0],["steer_x",0,0],["steer_y",0,0],["life",5,50],],]

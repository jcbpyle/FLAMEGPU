...
def generate_initial_states<xsl:if test="xmml:GeneratorName">_<xsl:value-of select="xmml:GeneratorName"/></xsl:if>(location_name=''):
	...
	global_data = {<xsl:for-each select="xmml:Globals/xmml:Global">"<xsl:value-of select="xmml:Name"/>":<xsl:choose><xsl:when test="xmml:Value/xmml:FixedValue">[<xsl:value-of select="xmml:Value/xmml:FixedValue"/>]</xsl:when><xsl:when test="xmml:Value/xmml:List"><xsl:choose><xsl:when test="xmml:Value/xmml:List/xmml:Select">random.choices([<xsl:value-of select="xmml:Value/xmml:List/xmml:Items"/>],k=<xsl:value-of select="xmml:Value/xmml:List/xmml:Select"/>)</xsl:when><xsl:otherwise>[<xsl:value-of select="xmml:Value/xmml:List/xmml:Items"/>]</xsl:otherwise></xsl:choose></xsl:when><xsl:when test="xmml:Value/xmml:Range"><xsl:choose><xsl:when test="xmml:Value/xmml:Range/xmml:Select">[<xsl:value-of select="xmml:Value/xmml:Type"/>(random.<xsl:value-of select="xmml:Value/xmml:Range/xmml:Distribution"/>(<xsl:value-of select="xmml:Value/xmml:Range/xmml:Min"/>,<xsl:value-of select="xmml:Value/xmml:Range/xmml:Max"/>)) for i in range(<xsl:value-of select="xmml:Value/xmml:Range/xmml:Select"/>)]</xsl:when><xsl:otherwise>range(<xsl:value-of select="xmml:Value/xmml:Range/xmml:Min"/>,<xsl:value-of select="xmml:Value/xmml:Range/xmml:Max"/><xsl:if test="xmml:Value/xmml:Range/xmml:Step">,<xsl:value-of select="xmml:Value/xmml:Range/xmml:Step"/></xsl:if>)</xsl:otherwise></xsl:choose></xsl:when><xsl:when test="xmml:Value/xmml:PythonRandom">[<xsl:if test="xmml:Value/xmml:Type"><xsl:value-of select="xmml:Value/xmml:Type"/>(</xsl:if>random.<xsl:value-of select="xmml:Value/xmml:PythonRandom/xmml:Function"/>(<xsl:value-of select="xmml:Value/xmml:PythonRandom/xmml:Arguments"/>)<xsl:if test="xmml:Value/xmml:Type">)</xsl:if>]</xsl:when><xsl:otherwise>[]</xsl:otherwise></xsl:choose><xsl:if test="not(position()=last())">,</xsl:if></xsl:for-each>}
	<!-- <xsl:for-each select="xmml:Globals/xmml:Global">
	<xsl:if test="xmml:Value">global_data += [["<xsl:value-of select="xmml:Name"/>", <xsl:choose><xsl:when test="xmml:Value/xmml:FixedValue"><xsl:value-of select="xmml:Value/xmml:FixedValue"/></xsl:when><xsl:when test="xmml:Value/xmml:List"><xsl:choose><xsl:when test="xmml:Value/xmml:List/xmml:Select">random.choices([<xsl:value-of select="xmml:Value/xmml:List/xmml:Items"/>],k=<xsl:value-of select="xmml:Value/xmml:List/xmml:Select"/>)</xsl:when><xsl:otherwise>[<xsl:value-of select="xmml:Value/xmml:List/xmml:Items"/>]</xsl:otherwise></xsl:choose></xsl:when><xsl:when test="xmml:Value/xmml:Range"><xsl:choose><xsl:when test="xmml:Value/xmml:Range/xmml:Select">[<xsl:value-of select="xmml:Value/xmml:Type"/>(random.<xsl:value-of select="xmml:Value/xmml:Range/xmml:Distribution"/>(<xsl:value-of select="xmml:Value/xmml:Range/xmml:Min"/>,<xsl:value-of select="xmml:Value/xmml:Range/xmml:Max"/>)) for i in range(<xsl:value-of select="xmml:Value/xmml:Range/xmml:Select"/>)]</xsl:when><xsl:otherwise>range(<xsl:value-of select="xmml:Value/xmml:Range/xmml:Min"/>,<xsl:value-of select="xmml:Value/xmml:Range/xmml:Max"/><xsl:if test="xmml:Value/xmml:Range/xmml:Step">,<xsl:value-of select="xmml:Value/xmml:Range/xmml:Step"/></xsl:if>)</xsl:otherwise></xsl:choose></xsl:when><xsl:when test="xmml:Value/xmml:PythonRandom">random.<xsl:value-of select="xmml:Value/xmml:PythonRandom/xmml:Function"/>(<xsl:value-of select="xmml:Value/xmml:PythonRandom/xmml:Arguments"/>)</xsl:when><xsl:otherwise>[]</xsl:otherwise></xsl:choose>]]<xsl:text>&#xa;</xsl:text><xsl:text>&#x9;</xsl:text></xsl:if>
	</xsl:for-each> -->
	</xsl:if>
	<xsl:if test="xmml:Populations">
	<xsl:for-each select="xmml:Populations/xmml:Population">
	<xsl:value-of select="xmml:Agent"/> = {<xsl:if test="xmml:InitialPopulationCount">"initial_population":<xsl:choose><xsl:when test="xmml:InitialPopulationCount/xmml:FixedValue">[<xsl:value-of select="xmml:InitialPopulationCount/xmml:FixedValue"/>]</xsl:when><xsl:when test="xmml:InitialPopulationCount/xmml:Range"><xsl:choose><xsl:when test="xmml:InitialPopulationCount/xmml:Range/xmml:Select">[int(random.<xsl:value-of select="xmml:InitialPopulationCount/xmml:Range/xmml:Distribution"/>(<xsl:value-of select="xmml:InitialPopulationCount/xmml:Range/xmml:Min"/>,<xsl:value-of select="xmml:InitialPopulationCount/xmml:Range/xmml:Max"/>)) for i in range(<xsl:value-of select="xmml:InitialPopulationCount/xmml:Range/xmml:Select"/>)]</xsl:when><xsl:otherwise>range(<xsl:value-of select="xmml:InitialPopulationCount/xmml:Range/xmml:Min"/>,<xsl:value-of select="xmml:InitialPopulationCount/xmml:Range/xmml:Max"/><xsl:if test="xmml:InitialPopulationCount/xmml:Range/xmml:Step">,<xsl:value-of select="xmml:InitialPopulationCount/xmml:Range/xmml:Step"/></xsl:if>)</xsl:otherwise></xsl:choose></xsl:when><xsl:when test="xmml:InitialPopulationCount/xmml:Value/xmml:PythonRandom">[<xsl:if test="xmml:InitialPopulationCount/xmml:Value/xmml:Type"><xsl:value-of select="xmml:InitialPopulationCount/xmml:Value/xmml:Type"/>(</xsl:if>random.<xsl:value-of select="xmml:InitialPopulationCount/xmml:Value/xmml:PythonRandom/xmml:Function"/>(<xsl:value-of select="xmml:InitialPopulationCount/xmml:Value/xmml:PythonRandom/xmml:Arguments"/>)<xsl:if test="xmml:InitialPopulationCount/xmml:Value/xmml:Type">)</xsl:if>]</xsl:when><xsl:otherwise>[0]</xsl:otherwise></xsl:choose>, </xsl:if><xsl:for-each select="xmml:Variables/xmml:Variable"><xsl:if test="not(xmml:Value/xmml:PerAgentRandom)">"<xsl:value-of select="xmml:Name"/>":<xsl:choose><xsl:when test="xmml:Value/xmml:FixedValue">[<xsl:value-of select="xmml:Value/xmml:FixedValue"/>]</xsl:when><xsl:when test="xmml:Value/xmml:Range"><xsl:choose><xsl:when test="xmml:Value/xmml:Range/xmml:Select">[<xsl:value-of select="xmml:Value/xmml:Type"/>(random.<xsl:value-of select="xmml:Value/xmml:Range/xmml:Distribution"/>(<xsl:value-of select="xmml:Value/xmml:Range/xmml:Min"/>,<xsl:value-of select="xmml:Value/xmml:Range/xmml:Max"/>)) for i in range(<xsl:value-of select="xmml:Value/xmml:Range/xmml:Select"/>)]</xsl:when><xsl:otherwise>range(<xsl:value-of select="xmml:Value/xmml:Range/xmml:Min"/>,<xsl:value-of select="xmml:Value/xmml:Range/xmml:Max"/><xsl:if test="xmml:Value/xmml:Range/xmml:Step">,<xsl:value-of select="xmml:Value/xmml:Range/xmml:Step"/></xsl:if>)</xsl:otherwise></xsl:choose></xsl:when><xsl:otherwise>[]</xsl:otherwise></xsl:choose><xsl:if test="not(position()=last())">,</xsl:if></xsl:if></xsl:for-each>}
	<xsl:value-of select="xmml:Agent"/>_vary_per_agent = {<xsl:for-each select="xmml:Variables/xmml:Variable"><xsl:if test="xmml:Value/xmml:PerAgentRandom">"<xsl:value-of select="xmml:Name"/>":[<xsl:value-of select="xmml:Value/xmml:PerAgentRandom/xmml:Min"/>,<xsl:value-of select="xmml:Value/xmml:PerAgentRandom/xmml:Max"/><xsl:if test="xmml:Value/xmml:PerAgentRandom/xmml:Distribution">,"<xsl:value-of select="xmml:Value/xmml:PerAgentRandom/xmml:Distribution"/>"</xsl:if><xsl:if test="xmml:Value/xmml:Type">,<xsl:value-of select="xmml:Value/xmml:Type"/></xsl:if>],</xsl:if></xsl:for-each>}<xsl:text>&#xa;</xsl:text><xsl:text>&#x9;</xsl:text>
	</xsl:for-each>

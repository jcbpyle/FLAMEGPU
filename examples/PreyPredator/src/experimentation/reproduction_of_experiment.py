...
def generate_initial_states_predpreygrass(location_name=''):
	...
	global_data = {"REPRODUCE_PREY_PROB":[float(random.uniform(0.0,0.25))],"REPRODUCE_PREDATOR_PROB":[float(random.uniform(0.0,0.25))],"GAIN_FROM_FOOD_PREY":[int(random.uniform(1,500))],"GAIN_FROM_FOOD_PREDATOR":[int(random.uniform(1,500))],"GRASS_REGROW_CYCLES":[int(random.uniform(1,500))]}
	prey = {"initial_population":[int(random.uniform(1,5000))], "type":[3.0],"steer_x":[0.0],"steer_y":[0.0],}
	...
	predator = {"initial_population":[int(random.uniform(1,5000))], "type":[1.0],"steer_x":[0.0],"steer_y":[0.0],}
	...
	grass = {"initial_population":[int(random.uniform(1,5000))], "type":[2.0],"dead_cycles":[0],"available":[1]}
...
############## random_parameter_search_experiment ############
